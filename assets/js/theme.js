...
var wizardInit = function wizardInit() {
  ...
  var inputEmail = document.querySelector('#wizard-email');
  var inputPassword = document.querySelector('#wizard-password');
  var form = document.querySelector('#bootstrap-wizard-tab1 .needs-validation');
